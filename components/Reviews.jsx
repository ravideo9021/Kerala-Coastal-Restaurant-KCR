    ...
    <section className="reviews section section--open" id="reviews" aria-labelledby="reviews-title">
      <div className="container">
        <header className="section-head reveal">
          <p className="script">Reviews</p>
          <h2 id="reviews-title">What our guests say</h2>
          <p className="lead">
            Read what diners say about us on Google, Zomato and Tripadvisor. Eaten with us? A quick review helps other
            Kerala-food lovers in Delhi find us.
          </p>
        </header>
        ...
        <div className="review-platforms">
          <a className="platform-card reveal" href={site.reviews.google} target="_blank" rel="noopener noreferrer">
            ...
            <span className="platform-text">
              ...
              <span>
                {rating
                  ? `${rating.value} ★ from ${rating.count.toLocaleString('en-IN')}+ reviews`
          ...
          <a
            className="platform-card platform-card--cta reveal"
            href={writeUrl}
            target="_blank"
